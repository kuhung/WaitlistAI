...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fkuhung%2FWaitlistAI)
...
3.  Run the development server:
    ...
    npm run dev
    ```
4.  Open [http://localhost:3000](http://localhost:3000) to start waiting.
...
3.  启动开发服务器：
    ...
    npm run dev
    ```
4.  打开 [http://localhost:3000](http://localhost:3000) 开始排队。

---

### Deployment Note / 部署说明

This project is configured to automatically track Git commit hashes in the footer for version control transparency.
本项目已配置在页脚自动追踪 Git 提交哈希值，以便于版本控制和调试。
